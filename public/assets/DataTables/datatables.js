 ...
 *   https://datatables.net/download/#dt/dt-2.0.2/b-3.0.1/b-colvis-3.0.1/sl-2.0.0
 *
 * Included libraries:
 *   DataTables 2.0.2, Buttons 3.0.1, Column visibility 3.0.1, Select 2.0.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-2.0.2/b-3.0.1/b-colvis-3.0.1/sl-2.0.0",
